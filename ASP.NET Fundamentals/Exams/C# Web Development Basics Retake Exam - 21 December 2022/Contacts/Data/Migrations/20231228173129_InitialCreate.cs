    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationUserContacts", x => new { x.ContactId, x.ApplicationUserId });
                    table.ForeignKey(
                        name: "FK_ApplicationUserContacts_ApplicationUsers_ApplicationUserId1",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationUserContacts_ApplicationUserId1",
